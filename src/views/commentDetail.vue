...
<script>
  import {Group, Cell, ViewBox, XTextarea } from 'vux'
  ...
  export default {
    ...
    data () {
      return {
        ...
        varmax:9,
        commentlist:[{name:'Kino的天空',time:'4月17日 22:05',commentWord:'我参加了周六上午的国画课，小朋友年纪小，希望从小培养，上课过程很开心！我参加了周六上午的国画课，小朋友年纪小，希望从小培养，上课过程很开心！'},
        {name:'chou的天空',time:'4月17日 22:05',commentWord:'希望从小培养，上课过程很开心！'},
