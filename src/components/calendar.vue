  ...
  <section class="wh_container">
    <div class="wh_content_all">
      ...
      <div class="wh_content">
        <div class="wh_content_item" v-for="(tag,index) in textTop" :key="'c'+index">
      ...
      <div class="wh_content">
        <div class="wh_content_item" v-for="(item,index) in list" @click="clickDay(item,index)" :key="'d'+index">
