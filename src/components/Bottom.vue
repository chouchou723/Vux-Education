<template>
    <div>
        <tabbar @on-index-change='indexChange' v-model="index">
            ...
            <tabbar-item link="/personal" @on-item-click="saveIndex">
                <!-- <img slot="icon" src="../assets/demo/icon_nav_article.png"> -->
                <img slot="icon" src="../assets/bi3.png">
                <img slot="icon-active" src="../assets/bi3s.png">
        ...
        <div v-transfer-dom>
            <confirm id="bottomConfirm" v-model="show" title="客服电话" content="确定拨打电话400-172-0748吗?" confirm-text='取消' cancel-text="确定" @on-cancel="onConfirm" @on-confirm="onCancel" @on-show="onShow">
...
<style>
    ...
    #bottomConfirm .weui-dialog__btn_default,
    #bottomConfirm .weui-dialog__btn_primary {
        color: #007AFF;
    }
</style>
