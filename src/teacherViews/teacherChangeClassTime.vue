    ...
    <div class="teacherChangeClassTime">
        <view-box ref="viewBox">
            <group title="修改课程内容" label-margin-right="2em">
                ...
                <datetime v-model="value3" @on-change="change" title="上课日期" @on-cancel="log('cancel')" @on-confirm="onConfirm"></datetime>
            ...
            <div class="footerBtn">
                <x-button type="primary" action-type="button" @click.native="saveInfo" :disabled="isloading">确认</x-button>
            </div>
        </view-box>
    </div>
</template>
