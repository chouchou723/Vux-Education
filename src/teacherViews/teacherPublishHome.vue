    ...
    <div class="teacherPublishHome">
        <view-box ref="viewBox">
            ...
            <group title="补充课程内容" label-margin-right="2em">
                ...
                <x-input v-model="value6" v-if="classtype!='SINGLE'" type="tel" mask="9999999999999"  placeholder-align="right" placeholder="请输入间隔天数" title="每隔几天上一次课" text-align='right'></x-input>
