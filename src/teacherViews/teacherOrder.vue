<template>
  <div class="teacherOrder">
       ...
       <tab-item selected>
        ...
        <tab-item>
            <span style="padding:0 25px;border-right:1px solid gainsboro">待上课</span>
        </tab-item>
      <tab-item>
           <span style="padding:0 25px;border-right:1px solid gainsboro">已上课</span>
           </tab-item>
...
export default {
  ...
  data () {
    ...
    {id:2,ishot:false,name:'创意绘画单课',total:8,hasJoin:5,content:'1节课-2课时|4-8岁儿童|满5人开课',price:120,status:'待上课'},
    {id:2,ishot:false,name:'创意绘画单课',total:8,hasJoin:5,content:'1节课-2课时|4-8岁儿童|满5人开课',price:120,status:'已上课'},
