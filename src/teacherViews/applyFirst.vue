  ...
  <div class="applyFirst">
   <view-box ref="viewBox">
      ...
      <div :class="['stepThree',step1>=3?'stepThreeAct':'']">
          ...
          <div :style="step1>=3?'color:#00a6e7':'color:grey'">等待审核</div>
      </div>
    </div>
    ...
    <!-- </group> -->
    <div class="footerBtn">
     <x-button type="primary" action-type="button"  @click.native="confireName">下一步</x-button>
...
<script>
  import { Step, StepItem,XButton, Group,XInput,ViewBox } from 'vux'
