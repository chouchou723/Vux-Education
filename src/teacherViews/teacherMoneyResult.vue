...
<script>
import {XButton,Group,CellBox,Flow, FlowState, FlowLine    } from 'vux'
import {pushHimOnWall} from '../api/api'
import apiHost from '../../config/prod.env'
export default {
  components: {
  XButton ,Group,CellBox,Flow, FlowState, FlowLine
  },
  data () {
    return {
...
.iconBg .weui-wepay-flow__info-left,.weui-wepay-flow__info-left:after{
    display: none;
}
