...
export const getStudentInfo = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/stus`, {
    params: params
  }).then(res => res.data);
};
//查询学生信息 个人主页
...
export const getLessonList = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/course`, {
    params: params
  }).then(res => res.data);
};
//获取所有场馆 
export const getAllVenue = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/venue/all`, {
    params: params
  }).then(res => res.data);
};
//根据场馆获取教室 
...
export const getCourseKind = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/course/kinds`, {
    params: params
  }).then(res => res.data);
};
//获取适用年龄 
export const getApplyAge = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/course/applyAge`, {
    params: params
  }).then(res => res.data);
};
...
export const lessonDateStatus = (id, params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/course/${id}/schedules`, {
    params: params
  }).then(res => res.data);
};
...
export const getMyLessonList = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/course/stu`, {
    params: params
  }).then(res => res.data);
};
//我的课程 我要评价提交
...
export const getMyOrder = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/orders/stu`, {
    params: params
  }).then(res => res.data);
};
//学生个人中心 提交订单
...
//学生个人中心 wx支付测试
export const getNewWxPay = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.post(`${base}/api/orders/newpay`, params).then(res => res.data);
};
//学生个人中心 付款获取wx jdk
...
export const getMyPoint = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/orders/myPoint`, {
    params: params
  }).then(res => res.data);
};
//学生个人中心 积分充值 暂无
...
export const getMyPurchase = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/orders/cost`, {
    params: params
  }).then(res => res.data);
};
//学生个人中心 我的作品列表
export const getMyPicture = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/stus/myPics`, {
    params: params
  }).then(res => res.data);
};
//学生个人中心 我的收藏列表
export const getMyCollect = (params, token) => {
  return AjaxPlugin.$http.get(`${base}/api/stus/myCollection`, {
    params: params
  }).then(res => res.data);
};
...
export const getAllComment = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/course/comment/all`, {
    params: params
  }).then(res => res.data);
};
//评价详情 
...
export const getTeacherLesson = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/course/my/tea`, {
    params: params
  }).then(res => res.data);
};
//教师获取主页信息 
export const getTeacherIndex = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/teachers/lit`, {
    params: params
  }).then(res => res.data);
};
//教师获取我的订单 
export const getTeacherOrder = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/orders/teacher`, {
    params: params
  }).then(res => res.data);
};
//教师获取我的财务记录 
export const getTeacherBuz = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/orders/teacher/buz`, {
    params: params
  }).then(res => res.data);
};
//教师获取我的提现记录 
export const getTeacherWithdraw = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/orders/teacher/withdraw`, {
    params: params
  }).then(res => res.data);
};
//教师 创建课程时的课程内容 
...
export const getTeacherAlreadyClass = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/course/content`, {
    params: params
  }).then(res => res.data);
};
//教师 创建课程下一步获取课程表
export const getTeacherschedules = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/course/schedules`, {
    params: params
  }).then(res => res.data);
};
//教师 创建新的课程内容
...
export const getTeacherschedulesByTmp = (params) => {
  // axios.defaults.headers.common['Authorization'] = token.Authorization;
  return AjaxPlugin.$http.get(`${base}/api/course/schedule/tmp`, {
    params: params
  }).then(res => res.data);
};
